...
public class ContenedorDeObjetos {
    ...
    public static final Target MENSAJE_ERROR = Target.the("Mensaje de error de credenciales").located(By.xpath("//p[contains(text(),'El Usuario y la Contraseña que ingresó no ha sido reconocido')]"));
}
